...
@Client.on_message(filters.command(["skip","boqua"], prefixes=f"{HNDLR}"))
...
@Client.on_message(filters.command(["tat", "stop"], prefixes=f"{HNDLR}"))
...
@Client.on_message(filters.command(["tamdumg","pause"], prefixes=f"{HNDLR}"))
...
@Client.on_message(filters.command(["resume","tieptuc"], prefixes=f"{HNDLR}"))
